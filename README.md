...
<p class="has-line-data" data-line-start="1" data-line-end="2"><a href="http://github.com/feelbetterhua/nvguideline_cn">github.com/feelbetterhua/nvguideline_cn</a></p>
<hr>
<p class="has-line-data" data-line-start="4" data-line-end="6"><img src="https://github.com/feelbetterhua/nvguideline_cn/blob/master/intro_pic.jpg?raw=true" alt="intro" title="intro"><br>
<strong>2019年了，新维加斯不应该是这个游戏体验</strong></p>
<p class="has-line-data" data-line-start="7" data-line-end="10">本指南旨在建立一种一站式的入门指导，帮助你了解游玩新维加斯需要的准备工作。并整合最新的优化配置选项，使你以最快的速度以及最丝滑的方式体验废土的旅程。<br>
...
<p class="has-line-data" data-line-start="11" data-line-end="12">首先说一下结论，我使用一台笔记本电脑，配置为</p>
<ul>
<li class="has-line-data" data-line-start="12" data-line-end="13">CPU：I7-5500U</li>
<li class="has-line-data" data-line-start="13" data-line-end="14">内存：8GB 1666Mhz DDR3</li>
<li class="has-line-data" data-line-start="14" data-line-end="15">显卡：GTX950m 2G DDR3</li>
<li class="has-line-data" data-line-start="15" data-line-end="16">硬盘：128GB SATA3.0 SSD</li>
<li class="has-line-data" data-line-start="16" data-line-end="18">系统：Win10 LTSC 2019</li>
</ul>
<p class="has-line-data" data-line-start="18" data-line-end="20">目前的设置优化可以使原版游戏在1080P，高画质下以60帧稳定运行。即使加了大量画质MOD后依旧可以在稍低分辨率下运行5~6个小时不跳出。这才是2019年的新维加斯应有的游戏体验。<br>
并且必须一提的是，网上流传了很久新维加斯不适合在Win10上运行。以目前的情况看已经没有那么不堪，我的LTSC是基于1809的，可以完美运行。</p>
<p class="has-line-data" data-line-start="21" data-line-end="24">一、一般信息<br>
...
<blockquote>
<p class="has-line-data" data-line-start="24" data-line-end="25">当然通过本指南，你可以最大化发挥硬件的资源。所以只要你的配置不是太差，莫哈维废土都可以任你驰骋。</p>
</blockquote>
<p class="has-line-data" data-line-start="26" data-line-end="27">对于版本的问题，网上流传着很多版本，但在这里只推荐Steam或GOG的终极版，也就是全DLC的版本。本指南编写的测试及适用版本为纯净的正版，其他版本不保证也有效果。</p>
<blockquote>
<p class="has-line-data" data-line-start="27" data-line-end="28">如果是完全纯净的学习版应该也可以</p>
</blockquote>
<p class="has-line-data" data-line-start="29" data-line-end="30">除此之外你还需要一个MOD管理器，也许对于本入门指南来说，MOD管理器并没有发挥太大左右，但熟悉MOD管理器将为你未来的游戏旅程很有帮助，本指南使用的是Mod Organizer 2。</p>
<blockquote>
<p class="has-line-data" data-line-start="30" data-line-end="31">如果你之前使用的是较老的MOD管理器，建议你更新到Mod Organizer 2。</p>
</blockquote>
...
<blockquote>
<p class="has-line-data" data-line-start="43" data-line-end="44">LTSC 2019是一个不错的选择</p>
</blockquote>
<p class="has-line-data" data-line-start="45" data-line-end="46">Win10系统可以设置优化的选项很多，网上也有许多关于此的指南，不在这里重复，主要说三点比较重要的：</p>
<ul>
<li class="has-line-data" data-line-start="46" data-line-end="47">关闭系统自带的游戏模式，对于新维加斯来说该模式会造成不稳定</li>
<li class="has-line-data" data-line-start="47" data-line-end="48">调整你的输入法，Win10自带的输入法影响了很多游戏，如果你不能保证游戏过程中不误触，最好的方法是单独添加英语作为第二键盘，并按alt+shift切换。</li>
<li class="has-line-data" data-line-start="48" data-line-end="50">关掉通知，以及其他可能在后台弹出对话框/提示的软件。新维加斯在切换窗口时卡死可能会让你疯掉，如果你必须要频繁切回桌面，后面针对此会有单独的步骤，但总的来说建议在游玩过程中尽量不要切回桌面。</li>
</ul>
<p class="has-line-data" data-line-start="50" data-line-end="52">对于笔记本电脑，请确保电源选项选择正确，如高性能或卓越性能。而对于所用用户，请更新到较新的显卡驱动，并保证有足够的硬盘空间。<br>
<strong>如果你之前安装过新维加斯后卸载，为保证本指南的能正常安装，请确保删除所有游戏文件、相关存档及注册表残余。</strong> 方法是使用搜索功能搜索Fallout NV相关的文件及文件夹后删除，并运行注册表清理工具删除相关残余条目。</p>
<blockquote>
<p class="has-line-data" data-line-start="52" data-line-end="53">注册表清理工具推荐 Wise Registry Cleaner</p>
</blockquote>
<p class="has-line-data" data-line-start="54" data-line-end="57">三、游戏安装<br>
1.安装参数：<br>
...
<p class="has-line-data" data-line-start="58" data-line-end="62">2.常用术语：<br>
...
<p class="has-line-data" data-line-start="63" data-line-end="66"><strong>3.禁用叠加层：</strong><br>
...
<p class="has-line-data" data-line-start="67" data-line-end="71">4.设置Fallout New Vegas Modding文件夹：<br>
...
<p class="has-line-data" data-line-start="72" data-line-end="75">5.生成新鲜的.INI文件：<br>
从根文件夹运行 FalloutNVLauncher.exe<br>
弹出 Detecting Video Hardware 的窗口，单击确定。之后弹出窗口提示程序根据你的硬件已设置画质，单击确定。</p>
<ul>
<li class="has-line-data" data-line-start="75" data-line-end="77">如果没有任何弹出窗口，请导航到 <em>文档/My Games/FalloutNV</em> 并删除以.INI结尾的所有文件，然后重新运行FalloutNVLauncher.exe</li>
</ul>
<p class="has-line-data" data-line-start="77" data-line-end="82">选择 Options<br>
...
<ul>
<li class="has-line-data" data-line-start="82" data-line-end="84">如果无法正常进入游戏，请参照步骤五为exe文件添加排除数据执行保护，再进行尝试</li>
</ul>
<p class="has-line-data" data-line-start="84" data-line-end="90">四、一些工具<br>
...
<ul>
<li class="has-line-data" data-line-start="90" data-line-end="92">FNV和4GB Patcher所需的库</li>
</ul>
<p class="has-line-data" data-line-start="92" data-line-end="100">2.Microsoft VC ++ 2015,2017,2019<br>
...
<ul>
<li class="has-line-data" data-line-start="100" data-line-end="102">Mod Organizer 2和NVGE所需的库</li>
</ul>
<p class="has-line-data" data-line-start="102" data-line-end="111">3.Mod Organizer 2<br>
...
<ul>
<li class="has-line-data" data-line-start="111" data-line-end="113">迄今为止所有Bethesda游戏的最佳mod管理器，利用虚拟文件系统保持您的Data文件夹完全干净</li>
</ul>
<p class="has-line-data" data-line-start="113" data-line-end="117">4.MO2插件<br>
...
<ul>
<li class="has-line-data" data-line-start="117" data-line-end="118">/data</li>
<li class="has-line-data" data-line-start="118" data-line-end="119"><a href="http://pySyncModOrder.py">pySyncModOrder.py</a></li>
<li class="has-line-data" data-line-start="119" data-line-end="121"><a href="http://pyMergePluginsHide.py">pyMergePluginsHide.py</a></li>
</ul>
<p class="has-line-data" data-line-start="121" data-line-end="126">5.正确更新Mod Organizer 2<br>
当发布新版本的Mod Organizer 2时：<br>
将新版压缩包解压到Mod Organizer 2文件夹中，并在出现提示时覆盖<br>
按照上述相同说明以管理员身份运行程序<br>
从上面重新下载并安装MO2插件</p>
<p class="has-line-data" data-line-start="127" data-line-end="134">五、汉化安装<br>
...
<p class="has-line-data" data-line-start="142" data-line-end="143">此时汉化已完成，Steam版可以直接双击FalloutNV.exe进入游戏，GOG版本需要下载破解的steam_api.dll放入根目录才能进入游戏。</p>
<blockquote>
<p class="has-line-data" data-line-start="143" data-line-end="144">汉化补丁替换了FalloutNV.exe，并且替换的exe来自Steam版。而GOG版与Steam版最大的区别是GOG版对exe文件进行了优化。所以如果想玩中文版的话建议直接买Steam版。</p>
</blockquote>
<p class="has-line-data" data-line-start="145" data-line-end="146">进入游戏，主界面和菜单应该都显示汉化。点击 选项-显示 ，滚轮滑倒最下，将 一般字幕 设置为开启。后退到主菜单，开始新游戏测试游戏内容及汉化是否有问题。</p>
<p class="has-line-data" data-line-start="147" data-line-end="162">六、Mod Organizer 2配置及INI优化<br>
...
<ul>
<li class="has-line-data" data-line-start="162" data-line-end="164">如果您的游戏是GOG版本，则加载顺序中可能存在FalloutNV_lang.esp ，请导航到/Data文件夹并将其删除</li>
</ul>
<p class="has-line-data" data-line-start="164" data-line-end="167">单击MO2顶部栏上的按钮<img src="https://github.com/feelbetterhua/nvguideline_cn/blob/master/MO2setting_pic.jpg?raw=true" alt="setting_pic" title="setting_pic">，导航到“ 路径”选项卡<br>
如果您使用SSD或空间很小的HDD，请将 下载 路径设置为具有足够空间的某个位置<br>
以下选项只在你有Nexus账户时才设置，没有的可以跳过</p>
<ul>
<li class="has-line-data" data-line-start="167" data-line-end="168">在 N网 选项卡中，单击 Connect to Nexus ，MO2应在浏览器中打开Nexus页面</li>
<li class="has-line-data" data-line-start="168" data-line-end="169">选择 Authorise</li>
<li class="has-line-data" data-line-start="169" data-line-end="171">等待页面提示 You have successfully logged into Mod Organizer 2! 后退出浏览器</li>
</ul>
<p class="has-line-data" data-line-start="171" data-line-end="172">点击 OK 退出MO2中的设置菜单，如果MO2提示你重启，你应该选择 Yes</p>
<p class="has-line-data" data-line-start="173" data-line-end="182">2.在Mod Organizer 2中创建新配置文件：<br>
...
<p class="has-line-data" data-line-start="183" data-line-end="192">3.调整FalloutCustom.ini：<br>
...
<p class="has-line-data" data-line-start="193" data-line-end="196">[BackgroundLoad]<br>
bBackgroundCellLoads=1<br>
bSelectivePurgeUnusedOnFastTravel=1</p>
<p class="has-line-data" data-line-start="197" data-line-end="211">[Display]<br>
...
<p class="has-line-data" data-line-start="212" data-line-end="219">[Controls]<br>
...
<p class="has-line-data" data-line-start="220" data-line-end="222">[Grass]<br>
fGrassStartFadeDistance=17000</p>
<p class="has-line-data" data-line-start="223" data-line-end="226">[Audio]<br>
iAudioCacheSize=8192<br>
iMaxSizeForCachedSound=2048</p>
<ul>
<li class="has-line-data" data-line-start="227" data-line-end="228">将INumHWThreads更改为CPU所具有的线程数，可以导航到 <em>文档/My Games/FalloutNV</em> 打开 RendererInfo.txt ，参考最后一行 HW Thread Count 后面的数字</li>
<li class="has-line-data" data-line-start="228" data-line-end="232">如果你不以16：9的宽高比运行游戏，可以删除<br>
fXenonVertLookSpeed=1200.0000<br>
fXenonHorizLookSpeed=1500.0000</li>
</ul>
<p class="has-line-data" data-line-start="232" data-line-end="233">完成后点击 保存 ，然后关闭INI编辑器。</p>
<p class="has-line-data" data-line-start="234" data-line-end="237">七、使用BethINI优化管理INI文件<br>
...
<p class="has-line-data" data-line-start="238" data-line-end="239">用BethINI的优点：</p>
<ul>
<li class="has-line-data" data-line-start="239" data-line-end="240">它会自动将您的INI文件重新排序为合理的顺序，使其更容易导航以进行手动调整。</li>
<li class="has-line-data" data-line-start="240" data-line-end="241">它自动修复常见错误，包括一些可能导致CTD的错误。</li>
<li class="has-line-data" data-line-start="241" data-line-end="242">它会自动检测您已安装的mod并在适当的情况下进行mod作者推荐的更改。</li>
<li class="has-line-data" data-line-start="242" data-line-end="243">它的预设在图形保真度和性能方面（95％的时间）优于通过游戏启动器创建的官方预设。</li>
<li class="has-line-data" data-line-start="243" data-line-end="244">它允许修改比通过本机游戏设置可访问的更多设置，并提供每个设置及其功能的说明。</li>
<li class="has-line-data" data-line-start="244" data-line-end="246">它会自动备份您的INI文件。</li>
</ul>
<p class="has-line-data" data-line-start="246" data-line-end="249">注意事项：<br>
...
<p class="has-line-data" data-line-start="250" data-line-end="251">安装使用说明：</p>
<ol>
<li class="has-line-data" data-line-start="251" data-line-end="252">运行前请确保已运行过FalloutNVLauncher.exe并生成了相应的INI文件</li>
<li class="has-line-data" data-line-start="252" data-line-end="253"><strong>请确保Mod Organizer 2关闭</strong>，解压缩文件到 <em>/Fallout NV Modding/Tools</em> 文件夹，进入并运行 BethINI.exe</li>
<li class="has-line-data" data-line-start="253" data-line-end="254">在弹出的窗口中下拉选择 Fallout New Vegas ，等待进入程序。</li>
<li class="has-line-data" data-line-start="254" data-line-end="255">进入程序后导航到 Setup 选项卡，<strong>取消选择</strong>下方的全部选项方框。之后在 Mod Organizer 一栏下拉菜单中选择 Browse ,在弹出的框中导航到 Mod Organizer 2 文件夹并双击选择 ModOrganizer.exe</li>
<li class="has-line-data" data-line-start="255" data-line-end="256">在 INI Path 一栏下拉菜单中选择您现在使用的Mod Organizer 2配置文件，如 ModOrganizer&gt;Core 。在弹出对话框中选择 确定 。此时会弹出对话框提示BethINI要重新启动，点击 确定 。重启后会弹出名为 Modify Custom INIs? 对话框，<strong>此时选择 否</strong> 。重新进入BethINI后导航到 Setup 选项卡，请确保全部5个选择框都没有选择。</li>
<li class="has-line-data" data-line-start="256" data-line-end="257">导航到 Basic 选项卡，在 Presets 栏中选择 BethINI Presets ，再选择 Recommended Tweaks ，程序会自动优化相应的INI文件，之后请根据配置在 Poor 到 Ultra 中选择合适的画质选项。</li>
<li class="has-line-data" data-line-start="257" data-line-end="258">选择完画质后在 Display 一栏中选择合适的分辨率，如果没有需要的分辨率则可以手动输入。可以自行选择 Antialiasing 和 Anisotropic Filtering 倍数。在右边选择 Allow 3.0 Shaders ，其他保持不变。最后选择最下方的 Enable File Selection (如果已经选择则不用管)，确定一切选择正确后点击 Save and Exit 退出。</li>
<li class="has-line-data" data-line-start="258" data-line-end="259">等待程序关闭后导航到 <em>文档/My Games/FalloutNV</em> 打开 RendererInfo.txt ，查看下方 Shader Package 后的数字。如果是19，则不需要进一步修改。如果不是19，请导航到游戏根目录下 <em>data/Shaders</em> 文件夹找到对应Shader Package后数字的文件，如 shaderpackage013.sdp ，将其命名为shaderpackage013.sdp.backup。之后把 shaderpackage019.sdp 复制一份到其他位置，将其重命名为shaderpackage013.sdp，再剪切回原文件夹。</li>
</ol>
<blockquote>
<p class="has-line-data" data-line-start="259" data-line-end="260">强制启用shaderpackage019以打开Shaders 3.0，这应该会增加游戏帧数及稳定性。</p>
</blockquote>
<p class="has-line-data" data-line-start="261" data-line-end="262"><strong>在使用了BethINI之后，请不要再运行FalloutNVLauncher.exe，也不要在Steam中启动新维加斯。如果在以后的游戏流程中需要修改画质及其他选项，请阅读指南最后有关BethINI的说明。</strong></p>
<p class="has-line-data" data-line-start="263" data-line-end="271">八、重要前置<br>
...
<ul>
<li class="has-line-data" data-line-start="271" data-line-end="273">扩展引擎的脚本功能，对于大多数mod来说都是必不可少的</li>
</ul>
<p class="has-line-data" data-line-start="273" data-line-end="277">NVSE_Config.ini<br>
...
<ul>
<li class="has-line-data" data-line-start="277" data-line-end="279">增加堆分配以帮助卡顿/崩溃</li>
</ul>
<p class="has-line-data" data-line-start="279" data-line-end="283">JIP LN NVSE插件<br>
...
<ul>
<li class="has-line-data" data-line-start="283" data-line-end="285">具有800多种新功能的NVSE扩展</li>
</ul>
<p class="has-line-data" data-line-start="285" data-line-end="292">4GBpatch<br>
...
<ul>
<li class="has-line-data" data-line-start="292" data-line-end="294">使游戏能够识别大地址，这意味着它可以使用4GB RAM而不是2GB</li>
</ul>
<p class="has-line-data" data-line-start="294" data-line-end="299"><strong>验证NVSE和4GBpatch是否运行：</strong><br>
打开Mod Organizer 2，在右栏上方的下拉菜单选择 NVSE ，点击运行<br>
进入游戏主菜单后，按 ~ 键打开控制台<br>
将getnvseversion输入控制台并按Enter键<br>
控制台应报告 NVSE version: 5</p>
<ul>
<li class="has-line-data" data-line-start="299" data-line-end="301">如果没有，请检查NVSE是否已正确安装并重试</li>
</ul>
<p class="has-line-data" data-line-start="301" data-line-end="303">将getislaa输入控制台并按Enter键<br>
控制台应该报告 GetisLAA &gt;&gt; 2.0000</p>
<ul>
<li class="has-line-data" data-line-start="303" data-line-end="304">如果控制台报告 GetisLAA &gt;&gt; 0.0000，则说明补丁未正确安装</li>
<li class="has-line-data" data-line-start="304" data-line-end="305">如果控制台报告 GetisLAA &gt;&gt; 1.0000，则修补程序已正确安装但无法正常运行，尝试以管理员身份运行</li>
<li class="has-line-data" data-line-start="305" data-line-end="307">如果控制台报告错误消息，则表示您未正确安装JIP LN NVSE</li>
</ul>
<p class="has-line-data" data-line-start="307" data-line-end="308"><strong>验证完成，之后都在Mod Organizer 2中通过NVSE进行游戏</strong></p>
<blockquote>
...
<ul>
<li class="has-line-data" data-line-start="341" data-line-end="343">添加新的渲染管道，更新默认着色器，并添加内存管理。<strong>有关NVGE的说明请参阅指南最后</strong></li>
</ul>
...
<blockquote>
<p class="has-line-data" data-line-start="391" data-line-end="392">有些用户报告此调整需要在 FalloutPrefs.ini 选项卡中进行</p>
</blockquote>
<p class="has-line-data" data-line-start="393" data-line-end="397">如果此方法不起作用，则使用方法二 OneTweak：<br>
